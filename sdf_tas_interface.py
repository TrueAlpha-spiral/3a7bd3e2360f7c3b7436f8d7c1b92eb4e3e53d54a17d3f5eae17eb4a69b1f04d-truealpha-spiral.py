...
class EpistemicCapsule:
    ...
    def payload(self) -> Dict[str, Any]:
        # Optimization: Manually constructing the dictionary instead of using dataclasses.asdict() avoids recursive type checking and deep copying overhead, ~16x speedup.
        return {
