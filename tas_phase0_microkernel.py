...
class Phase0Manifest:
    ...
    def canonical_bytes(self) -> bytes:
        ...
        # Optimization: Manually constructing the dictionary is measurably faster (~5x speedup) than using dataclasses.asdict() on flat dataclasses by avoiding recursive type-checking and deep-copy overhead.
        payload = {
            "phase": self.phase,
